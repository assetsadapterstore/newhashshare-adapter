...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO NHSS", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W6QXZZvodPfBF2xoxSQHCAHm5D9v47jABF")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WLNJtiXkxiBqQNKct21X8W7JUxYyBw7VLe"
	account := &openwallet.AssetsAccount{Alias: "mainnetNHSS", WalletID: walletID, Required: 1, Symbol: "NHSS", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WLNJtiXkxiBqQNKct21X8W7JUxYyBw7VLe"
	accountID := "6KrNLapALPvAZvofUeFUDCtebVjRCarsDhhBvWiRsPEW"
...
func TestWalletManager_GetAddressList(t *testing.T) {
	...
	walletID := "WLNJtiXkxiBqQNKct21X8W7JUxYyBw7VLe"
	accountID := "6KrNLapALPvAZvofUeFUDCtebVjRCarsDhhBvWiRsPEW"
	//accountID := "7BQ5HLsk3uNiWsX4ajPgii7fq2LYUs99bT31gJqNy2jL"
